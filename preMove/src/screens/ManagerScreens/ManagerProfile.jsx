...
export default function ManagerProfile({ navigation }) {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Auto-close success modal and navigate after 2 seconds
      setTimeout(() => {
  ...
  return (
    <ScrollView style={AccountScreenCss.container}>
      ...
      {/* Options List */}
      <View style={[AccountScreenCss.card, { margin: 50, paddingVertical: 50 }]}>
        {/* Profile */}
        <TouchableOpacity style={AccountScreenCss.item} onPress={() => navigation.navigate('ManagerProfileScreen')}>
